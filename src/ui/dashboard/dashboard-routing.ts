...
export function isDashboardServerRoutePage(
  value: string | null | undefined
): value is DashboardServerRoutePage {
  return dashboardServerRoutePages.includes(
    value as (typeof dashboardServerRoutePages)[number]
  );
}

export function resolveDashboardServerRoutePage(
  value: string | null | undefined
): DashboardServerRoutePage {
  return isDashboardServerRoutePage(value) ? value : "overview";
}

export function getDashboardAppPath(
  locale: Locale,
